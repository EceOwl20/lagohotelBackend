      ...
      const fetchData = async () => {
        try {
          const res = await fetch(
            `${apiUrl}/api/pages/rooms/subroom/FamilyRoom?lang=${locale}`
          );
...
//https://kuula.co/share/collection/7byM9?logo=1&info=0&fs=1&vr=1&autorotate=0.22&autop=10&autopalt=1&thumbs=4&margin=2&alpha=0.72
//https://kuula.co/share/collection/7bWS8?logo=1&info=0&fs=1&vr=1&autorotate=0.22&autop=10&autopalt=1&thumbs=4&margin=2&alpha=0.72