...
const Page = () => {
  ...
  return (
    <div className=' overflow-hidden flex flex-col items-center justify-center gap-[60px] md:gap-[80px] lg:gap-[100px] bg-[#fbfbfb]'>
     ...
     <SubRoomBanner img={pageData.banner.image || img1} span={pageData.banner.subtitle?.[locale] || t("subtitle")} header={pageData.banner.title?.[locale] || t("title")} texts={subroomBannerText} baby={pageData.banner.baby || false}/>
     <SubroomCarousel images={carouselImages}/>
     </div>
      <RoomFeatures span={pageData.features.span?.[locale] } header={pageData.features.header?.[locale] || t2("title")} text={pageData.features.text?.[locale] || t2("text")} header2={pageData.features.header2?.[locale] || t2("title2")} header3={pageData.features.header3?.[locale] || t2("title3")}  text2={pageData.features.text2?.[locale] || t2("text2")} iconsTexts={iconTexts}  roomName="SuperiorRoom" pool={false}/>
