...
const Page = () => {
  ...
  return (
    <div className=' overflow-hidden flex flex-col items-center justify-center gap-[60px] md:gap-[80px] lg:gap-[100px] bg-[#fbfbfb]'>
     ...
     <SubRoomBanner img={img1} span={pageData.banner.subtitle?.[locale] || t("subtitle")} header={pageData.banner.title?.[locale] || t("title")} texts={subroomBannerText} baby={true}/>
     <SubroomCarousel images={carouselImages}/>
     </div>
      <RoomFeatures span={pageData.features.span?.[locale] || t2("subtitle")} header={pageData.features.header?.[locale] || t2("title")} text={t2("text")} header2={t2("title2")} header3={t2("title3")}  text2={t2("text2")} iconsTexts={iconTexts}  roomName="SuperiorRoom" pool={false}/>
