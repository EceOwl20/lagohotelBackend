// app/[locale]/panel/sayfalar/spa/page.js
"use client";
...
export default function SpaPanelPage() {
    ...
    () => [
      {
        ...
        render: () => (
          <MainBannerEdit
            ...
            blockName="mainBanner"
          />
        ),
      },
      {
        id: "spa-info",
        title: "💆 Spa Info Section",
        render: () => (
          <SpaInfoSectionEdit
            data={data}
            setData={setData}
      ...
      {
        id: "spa-header",
        title: "🧖 Spa Header Section",
        render: () => (
          <SpaHeaderSectionEdit
            data={data}
            setData={setData}
            langs={LANGS}
            activeLang={activeLang}
      ...
      },
      {
        ...
        render: () => (
          <MassageCarouselEdit
            ...
            langs={LANGS}
            activeLang={activeLang}
            blockName="massageCarousel"
          />
        ),
      },
      {
        id: "spa-types",
        title: "🌿 Spa Types Info",
        render: () => (
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        const res = await fetch(`${apiUrl}/api/pages/spa`);
